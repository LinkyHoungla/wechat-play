...
public class PermissionController {
    ...
    @PostMapping("/role")
    public ApiResponse<Integer> addRole(@RequestBody @Valid RoleParam param) {
        return ApiResponse.success(permissionService.addRole(param));
    }

    @PutMapping("/role/{id}")
    public ApiResponse<Integer> updateRole(@PathVariable("id") @Min(1) Integer id, @RequestBody @Valid RoleParam param) {
